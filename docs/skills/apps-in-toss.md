...
- [한 눈에 보기](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/시작하기/overview.md): 앱인토스 API & SDK에서 제공하는 주요 기능을 한눈에 살펴볼 수 있어요.
...
- [Storage](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/저장소/Storage.md)
...
- [언어 (`getLocale`)](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/언어/getLocale.md)
...
- [사용자 식별키 발급 (`getAnonymousKey`) - 비게임](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/비게임/getAnonymousKey.md)
- [사용자 식별키 발급 (`getUserKeyForGame`) - 게임](https://developers-apps-in-toss.toss.im/bedrock/reference/framework/게임/getUserKeyForGame.md)
